...
<div class="top-bar animated wow fadeInDown">
   <div class="container-fluid">
    <div class="row">
     <div class="col-md-1 text-center"> 
       <a class="bar-logo" href="<?php echo site_url();?>"><img src="<?php echo get_option_tree('header_logo');?>" alt="LOGO" /></a>
     </div>
 ...
 <div class="magazine-nav top-middle animated wow fadeInUp">
  <a class="logo" href="<?php echo site_url();?>"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/1-Mylkshake-Blog1.png" alt="..." /></a>
  
  <div class="container-fluid">
    <div class="row">
       <div class="col-xs-12">
         <a class="bar-logo" href="<?php echo site_url(); ?>">
