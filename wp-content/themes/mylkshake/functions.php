...
function my_loginlogo() {
  echo '<style type="text/css">
	...
	h1 a {
	  background-image:url(' . get_template_directory_uri() . '/images/wp-logo.png) !important;
...
add_image_size( 'social', 349, 394, true );
add_image_size( 'blog-inner', 779, 372, true );
add_image_size( 'blog-small', 247, 172, true );